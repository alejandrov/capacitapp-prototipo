  ...
  return (
    <div style={{ 
      ...
      <p style={{ 
        ...
        Administra los cursos disponibles para los empleados
      </p>
      ...
      <div style={{
        ...
        {cursos.map((curso) => (
          ...
          >
            ...
            <button
              onClick={() => curso.editable ? handleEditCurso(curso.route) : null}
              style={{
                display: 'flex',
                alignItems: 'center',
                gap: '8px',
                padding: '8px 16px',
                backgroundColor: curso.editable ? 'rgba(26, 16, 96, 0.1)' : '#f5f5f5',
