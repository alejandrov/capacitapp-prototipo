...
const SafetyCourse = () => {
  ...
  const [modules, setModules] = useState([
    ...
    },
    {
      ...
      description:
        "Conocerás y aprenderás a utilizar el equipo de protección adecuado.",
      completed: false,
      route: null,
    },
    {
  ...
  const handleModuleAction = (moduleIndex) => {
    ...
    if (selectedModule.completed) {
      ...
      const filteredModules = completedModules.filter(
    ...
    >
      ...
      >
        ...
        <div className="course-icon-section">
          ...
          <p className="module-count" style={{ marginTop: "-15px" }}>
            4 módulos
          </p>
        </div>
        ...
        <div className="progress-section">
          ...
          >
            ...
            <div className="progress-info">
              <span>
                {modules.filter((m) => m.completed).length} Módulos completados
              </span>
        ...
        <div className="modules-section">
          ...
          <ul>
            ...
            <li>
              Utilizar el equipo de protección y seguir las medidas de seguridad
              adecuadas para trabajar en grandes alturas o temperaturas elevadas
              o con electricidad
            </li>
          </ul>
        </div>
            ...
            >
              ...
              <div className="module-actions" style={{ marginTop: "-10px" }}>
                {index < 3 ? (
                  ...
                  <Button
                    variant={
                      isComplementaryTestAvailable() ? "primary" : "secondary"
                    }
                    onClick={() => handleModuleAction(index)}
